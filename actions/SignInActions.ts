...
export const createAccountUser = ( email: string, password: string, Editor: boolean,
...
export const EditUserInfo = ( uid: number, firstName: string, lastName: string, Editor: boolean) => {
    return (dispatch) => {
